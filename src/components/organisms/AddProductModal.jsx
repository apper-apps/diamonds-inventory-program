...
setFormData({
          ...
          category_c: editProduct.category_c || "",
          gold_type_c: editProduct.gold_type_c || "",
          diamond_type_c: editProduct.diamond_type_c || "",
          diamond_quality_c: editProduct.diamond_quality_c || "",
          diamond_color_c: editProduct.diamond_color_c || "",
          certificate_number_c: editProduct.certificate_number_c || "",
          weight_c: editProduct.weight_c?.toString() || "",
          diamond_weight_c: editProduct.diamond_weight_c?.toString() || "",
          dimensions_c: editProduct.dimensions_c || "",
          specifications_c: editProduct.specifications_c || "",
          price_c: editProduct.price_c?.toString() || "0",
          description_c: editProduct.description_c || "",
          status_c: editProduct.status_c || "Available",
          barcode_c: editProduct.barcode_c || "",
          images_c: editProduct.images_c || "",
          making_charge_c: editProduct.making_charge_c?.toString() || "0",
          labour_charge_c: editProduct.labour_charge_c?.toString() || "0",
          manualPricing: false
        });
      } else {
setFormData({
